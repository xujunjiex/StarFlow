...
interface BatchOcrOps {
    ...
    suspend fun detectLinesV5(ctx: Context, bmp: Bitmap): List<CroppedTextLine>
    suspend fun detectLinesV6(ctx: Context, bmp: Bitmap): List<CroppedTextLine>
...
object RealBatchOcrOps : BatchOcrOps {
    ...
    override suspend fun detectLinesV5(ctx: Context, bmp: Bitmap): List<CroppedTextLine> =
        DetectionBridge.detectAndCropPPOcrV5Lines(ctx, bmp)

    override suspend fun detectLinesV6(ctx: Context, bmp: Bitmap): List<CroppedTextLine> =
        DetectionBridge.detectAndCropPPOcrV6Lines(ctx, bmp)
